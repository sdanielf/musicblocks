...
const RODENTS = [_('raton'), _('brown rat'), _('mole'), _('chipmunk'), _('red squirrel'), _('guinea pig'), _('capybara'), _('coypu'), _('black rat'), _('grey squirrel'), _('flying squirrel'), _('bat')];
...
saveLilypondOutput = function(logo, saveName) {
    ...
    for (var t in logo.lilypondStaging) {
        if (logo.lilypondStaging[t].length > 0) {
            ...
            if (instrumentName === _('iniciar') || instrumentName === _('iniciar tambor')) {
